    ...
    <section className='column-3'>
      ...
      <div className="info-sections">
        <div className="info-item">
          <img src={BirthIcon}  className="info-icon"/> {/* Replace with your icon */}
        ...
        <div className="info-item">
        <img src={FemaleIcon}  className="info-icon"/> {/* Replace with your icon */}
          <div className="info-content">
            <h3>Gender</h3>
        ...
        <div className="info-item">
        <img src={PhoneIcon}  className="info-icon"/> {/* Replace with your icon */}
          <div className="info-content">
            <h3>Contact Info</h3>
        ...
        <div className="info-item">
        <img src={InsuranceIcon}  className="info-icon"/> {/* Replace with your icon */}
          <div className="info-content">
